...
exports.getAll = function(req, res) {
    ...
    if((typeof query_params.lat === 'undefined') || (typeof query_params.lng === 'undefined')) {
        ...
        console.log(whereClause);
        var  query = client.query("select * from specials "+whereClause+" order by point(lng,lat) <@> point("+query_params['lng']+","+query_params['lat']+") limit 25 offset "+query_params['offset'],[],function(err,result){
            if(err) {
